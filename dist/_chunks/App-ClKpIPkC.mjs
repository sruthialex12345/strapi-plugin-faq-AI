...
import { Flex, Box, Popover, Typography, Button, LinkButton, Link, Portal, Alert, Field, SubNav, Badge, TextInput, Divider, Accordion, Checkbox, SingleSelect, SingleSelectOption, Textarea, Modal, Loader, Main } from "@strapi/design-system";
import { WarningCircle, CaretDown, ChevronDown, Message, ArrowClockwise, Cross, PaperPlane, Plus, Trash, Pencil, ArrowLeft, Check } from "@strapi/icons";
import "react-dom/client";
import ReactDOM, { unstable_batchedUpdates as unstable_batchedUpdates$1 } from "react-dom";
import { useIntl, FormattedMessage } from "react-intl";
import "@strapi/icons/symbols";
import styled$1, { styled, createGlobalStyle } from "styled-components";
...
const ConfigSettings = ({
  ...
  const SettingRow = ({
    ...
    value,
    type: type2
  }) => /* @__PURE__ */ jsx(Box, { paddingLeft: 6, paddingRight: 6, paddingTop: 4, paddingBottom: 4, children: /* @__PURE__ */ jsxs(Flex, { justifyContent: "space-between", alignItems: "center", children: [
    /* @__PURE__ */ jsx(Typography, { variant: "omega", fontWeight: "bold", children: title }),
      ...
      value ? (
        ...
        /* @__PURE__ */ jsx(
          Box,
          {
            ...
            children: /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral600", children: type2 === "key" ? "••••••••••••" : value })
          }
        )
      ) : /* @__PURE__ */ jsx(Typography, { variant: "sigma", textColor: "danger600", fontWeight: "bold", children: "NOT CONFIGURED" }),
      /* @__PURE__ */ jsx(Button, { variant: "tertiary", onClick: () => onManage(type2), children: "Manage" })
    ] })
  ] }) });
  return /* @__PURE__ */ jsxs(Box, { background: "neutral0", shadow: "filterShadow", hasRadius: true, marginBottom: 6, children: [
    /* @__PURE__ */ jsx(
      SettingRow,
      {
        type: "domain",
...
const DeleteButton = styled$1(Button)`
  &:hover {
...
const CollectionSection = ({
  ...
  return /* @__PURE__ */ jsxs(Box, { background: "neutral0", shadow: "filterShadow", hasRadius: true, paddingBottom: collections.length > 0 ? 4 : 0, marginBottom: 6, children: [
    /* @__PURE__ */ jsx(Box, { padding: 6, children: /* @__PURE__ */ jsxs(Flex, { justifyContent: "space-between", alignItems: "center", children: [
      /* @__PURE__ */ jsx(Typography, { variant: "delta", fontWeight: "bold", children: "Collections" }),
      /* @__PURE__ */ jsx(
        Button,
        {
          variant: "secondary",
    ...
    collections.length > 0 && /* @__PURE__ */ jsx(Accordion.Root, { type: "multiple", children: collections.map((c2) => {
      const allChecked = c2.fields.every((f2) => f2.enabled);
      const someChecked = c2.fields.some((f2) => f2.enabled);
      return /* @__PURE__ */ jsxs(Accordion.Item, { value: c2.uid, children: [
        /* @__PURE__ */ jsxs(Accordion.Header, { children: [
          /* @__PURE__ */ jsx(Accordion.Trigger, { children: /* @__PURE__ */ jsxs(Box, { paddingLeft: 2, textAlign: "left", children: [
            /* @__PURE__ */ jsx(Typography, { variant: "delta", fontWeight: "bold", display: "block", children: c2.name }),
          ...
          /* @__PURE__ */ jsx(Box, { paddingRight: 4, children: /* @__PURE__ */ jsx(
            DeleteButton,
            {
              variant: "ghost",
              title: "Remove",
              ...
              style: { padding: "8px" },
              children: /* @__PURE__ */ jsx(Trash, { width: "16px", height: "16px" })
            }
          ) })
        ] }),
        /* @__PURE__ */ jsx(Accordion.Content, { children: /* @__PURE__ */ jsxs(Box, { background: "neutral100", padding: 4, children: [
          ...
          /* @__PURE__ */ jsx(Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsx(Flex, { gap: 4, wrap: "wrap", children: c2.fields.map((f2) => /* @__PURE__ */ jsx(Box, { style: { minWidth: "140px" }, children: /* @__PURE__ */ jsxs(Flex, { alignItems: "center", gap: 2, children: [
            /* @__PURE__ */ jsx(
              Checkbox,
              {
                checked: f2.enabled,
            ...
            /* @__PURE__ */ jsx(Typography, { variant: "omega", children: f2.name })
          ] }) }, f2.name)) }) }),
          /* @__PURE__ */ jsxs(Box, { paddingTop: 4, children: [
            /* @__PURE__ */ jsx(Typography, { variant: "sigma", textColor: "neutral600", display: "block", marginBottom: 2, children: "CARD STYLES" }),
            /* @__PURE__ */ jsx(Divider, { marginBottom: 4 }),
            /* @__PURE__ */ jsx(Box, { width: "300px", children: /* @__PURE__ */ jsx(
              SingleSelect,
              {
                ...
                children: cardOptions.map((c22) => /* @__PURE__ */ jsx(SingleSelectOption, { value: c22.id, children: c22.label }, c22.id))
              }
            ) })
          ] })
        ] }) })
...
`;
const DangerActionButton = styled$1(ActionButton)`
...
const SuggestedQuestions = ({ questions, onAddClick, onEditClick, onRemove }) => {
  return /* @__PURE__ */ jsxs(Box, { background: "neutral0", shadow: "filterShadow", hasRadius: true, paddingBottom: questions.length > 0 ? 4 : 0, marginBottom: 6, children: [
    /* @__PURE__ */ jsx(Box, { padding: 6, children: /* @__PURE__ */ jsxs(Flex, { justifyContent: "space-between", alignItems: "center", children: [
      /* @__PURE__ */ jsx(Typography, { variant: "delta", fontWeight: "bold", children: "Suggested Questions" }),
      /* @__PURE__ */ jsx(Button, { variant: "secondary", startIcon: /* @__PURE__ */ jsx(Plus, {}), onClick: onAddClick, children: "Add Suggestion" })
    ] }) }),
    questions.length > 0 && /* @__PURE__ */ jsx(Flex, { direction: "column", alignItems: "stretch", gap: 2, paddingLeft: 6, paddingRight: 6, paddingBottom: 4, children: questions.map((q2, index) => /* @__PURE__ */ jsxs(Flex, { padding: 3, hasRadius: true, background: "neutral100", justifyContent: "space-between", alignItems: "center", children: [
      /* @__PURE__ */ jsx(Typography, { variant: "omega", textColor: "neutral800", children: q2 }),
      /* @__PURE__ */ jsxs(Flex, { gap: 1, children: [
        /* @__PURE__ */ jsx(ActionButton, { onClick: () => onEditClick(index), title: "Edit", children: /* @__PURE__ */ jsx(Pencil, {}) }),
        /* @__PURE__ */ jsx(DangerActionButton, { onClick: () => onRemove(index), title: "Remove", children: /* @__PURE__ */ jsx(Trash, {}) })
      ] })
    ] }, index)) })
  ] });
};
const InstructionRow = ({
  ...
  /* @__PURE__ */ jsx(Box, { paddingLeft: 6, paddingRight: 6, paddingTop: 4, paddingBottom: 4, children: /* @__PURE__ */ jsxs(Flex, { justifyContent: "space-between", alignItems: "center", children: [
    /* @__PURE__ */ jsx(Typography, { variant: "omega", fontWeight: "bold", children: title }),
    /* @__PURE__ */ jsxs(Flex, { gap: 3, alignItems: "center", children: [
      !value && !isOpen && /* @__PURE__ */ jsx(Typography, { variant: "sigma", textColor: "danger600", fontWeight: "bold", children: "NOT CONFIGURED" }),
      /* @__PURE__ */ jsx(Button, { variant: "tertiary", onClick: onToggle, children: isOpen ? "Apply" : "Manage" })
    ] })
  ] }) }),
  isOpen && /* @__PURE__ */ jsx(Box, { paddingLeft: 6, paddingRight: 6, paddingBottom: 6, background: "neutral0", children: /* @__PURE__ */ jsx(Box, { paddingTop: 2, children: /* @__PURE__ */ jsx(
    Textarea,
    {
      placeholder: placeholder2,
      value,
  ...
  return /* @__PURE__ */ jsxs(Box, { background: "neutral0", shadow: "filterShadow", hasRadius: true, marginBottom: 6, children: [
    /* @__PURE__ */ jsx(
      Box,
      {
        ...
        children: /* @__PURE__ */ jsx(Typography, { variant: "delta", fontWeight: "bold", children: "Instructions" })
      }
    ),
    /* @__PURE__ */ jsx(
      InstructionRow,
...
const PopUp = ({ isOpen, onClose, onSave, type: type2, initialData, availableCollections = [] }) => {
  ...
  const getModalContent = () => {
    if (type2 === "logo" && isPickerOpen) {
      return /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 4, alignItems: "stretch", children: [
        /* @__PURE__ */ jsx(Button, { variant: "tertiary", startIcon: /* @__PURE__ */ jsx(ArrowLeft, {}), onClick: () => setIsPickerOpen(false), children: "Back to Preview" }),
        isLoadingAssets ? /* @__PURE__ */ jsx(Flex, { justifyContent: "center", padding: 8, children: /* @__PURE__ */ jsx(Loader, {}) }) : /* @__PURE__ */ jsx(Flex, { wrap: "wrap", gap: 4, children: assets.map((asset) => /* @__PURE__ */ jsx(
          Box,
          {
            as: "button",
            type: "button",
            ...
            children: /* @__PURE__ */ jsx("img", { src: asset.url, alt: asset.name, style: { width: "100%", height: "100%", objectFit: "cover" } })
          },
          asset.id
        )) })
      ] });
    ...
    switch (type2) {
      ...
      case "logo":
        return /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 4, alignItems: "stretch", children: [
          /* @__PURE__ */ jsx(Typography, { variant: "pi", fontWeight: "bold", textColor: "neutral600", children: "Logo Preview" }),
          /* @__PURE__ */ jsx(
            Box,
            {
              ...
              children: tempData ? /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 4, alignItems: "center", children: [
                /* @__PURE__ */ jsx("img", { src: tempData, alt: "Logo", style: { maxHeight: "120px", maxWidth: "100%", borderRadius: "4px" } }),
                /* @__PURE__ */ jsx(Button, { variant: "danger-light", startIcon: /* @__PURE__ */ jsx(Trash, {}), onClick: () => setTempData(""), children: "Remove Logo" })
              ] }) : /* @__PURE__ */ jsxs(Flex, { direction: "column", gap: 4, alignItems: "center", children: [
                /* @__PURE__ */ jsx(Button, { variant: "secondary", startIcon: /* @__PURE__ */ jsx(Plus, {}), onClick: () => setIsPickerOpen(true), children: "Select Logo" }),
                /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral500", children: "Pick from Media Library" })
              ] })
            }
          )
        ] });
      case "collections":
        return /* @__PURE__ */ jsx(Flex, { direction: "column", gap: 3, children: availableCollections.map((col) => {
          ...
          return /* @__PURE__ */ jsx(
            Box,
            {
              ...
              children: /* @__PURE__ */ jsxs(Flex, { direction: "column", alignItems: "flex-start", children: [
                /* @__PURE__ */ jsx(Typography, { fontWeight: "bold", textColor: isSelected ? "primary600" : "neutral800", children: col.name }),
                /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral500", children: col.uid })
              ] })
            },
            col.uid
          );
  ...
  return /* @__PURE__ */ jsx(Modal.Root, { open: isOpen, onOpenChange: onClose, children: /* @__PURE__ */ jsxs(Modal.Content, { children: [
    /* @__PURE__ */ jsx(Modal.Header, { children: /* @__PURE__ */ jsx(Typography, { fontWeight: "bold", as: "h2", children: titles[type2] }) }),
    /* @__PURE__ */ jsx(Modal.Body, { children: /* @__PURE__ */ jsx(Box, { paddingTop: 2, paddingBottom: 2, children: getModalContent() }) }),
    /* @__PURE__ */ jsxs(Modal.Footer, { children: [
      /* @__PURE__ */ jsx(Button, { onClick: onClose, variant: "tertiary", children: "Cancel" }),
      !isPickerOpen && /* @__PURE__ */ jsx(Button, { onClick: () => {
        onSave(tempData);
        onClose();
