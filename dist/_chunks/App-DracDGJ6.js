...
const ConfigSettings = ({
  ...
  const SettingRow = ({
    ...
    value,
    type: type2
  }) => /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingLeft: 6, paddingRight: 6, paddingTop: 4, paddingBottom: 4, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", alignItems: "center", children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "omega", fontWeight: "bold", children: title }),
      ...
      value ? (
        ...
        /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Box,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral600", children: type2 === "key" ? "••••••••••••" : value })
          }
        )
      ) : /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", textColor: "danger600", fontWeight: "bold", children: "NOT CONFIGURED" }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "tertiary", onClick: () => onManage(type2), children: "Manage" })
    ] })
  ] }) });
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { background: "neutral0", shadow: "filterShadow", hasRadius: true, marginBottom: 6, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      SettingRow,
      {
        type: "domain",
...
const CollectionSection = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { background: "neutral0", shadow: "filterShadow", hasRadius: true, paddingBottom: collections.length > 0 ? 4 : 0, marginBottom: 6, children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 6, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", alignItems: "center", children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", fontWeight: "bold", children: "Collections" }),
      /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.Button,
        {
          variant: "secondary",
    ...
    collections.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Accordion.Root, { type: "multiple", children: collections.map((c2) => {
      const allChecked = c2.fields.every((f2) => f2.enabled);
      const someChecked = c2.fields.some((f2) => f2.enabled);
      return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Accordion.Item, { value: c2.uid, children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Accordion.Header, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Accordion.Trigger, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { paddingLeft: 2, textAlign: "left", children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", fontWeight: "bold", display: "block", children: c2.name }),
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, { variant: "pi", textColor: "neutral600", children: [
              "Define all allowed fields for ",
              c2.name,
              "."
            ] })
          ] }) }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingRight: 4, children: /* @__PURE__ */ jsxRuntime.jsx(
            DeleteButton,
            {
              variant: "ghost",
              title: "Remove",
              ...
              style: { padding: "8px" },
              children: /* @__PURE__ */ jsxRuntime.jsx(icons.Trash, { width: "16px", height: "16px" })
            }
          ) })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Accordion.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { background: "neutral100", padding: 4, children: [
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", alignItems: "center", paddingBottom: 2, children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(
              designSystem.Checkbox,
              {
                ...
                onCheckedChange: (value) => onToggleAll(c2.uid, !!value),
                children: "Select all"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Divider, { marginBottom: 3 }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 2, paddingBottom: 4, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { gap: 4, wrap: "wrap", children: c2.fields.map((f2) => /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { style: { minWidth: "140px" }, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { alignItems: "center", gap: 2, children: [
            /* @__PURE__ */ jsxRuntime.jsx(
              designSystem.Checkbox,
              {
                checked: f2.enabled,
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "omega", children: f2.name })
          ] }) }, f2.name)) }) }),
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { paddingTop: 4, children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", textColor: "neutral600", display: "block", marginBottom: 2, children: "CARD STYLES" }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Divider, { marginBottom: 4 }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { width: "300px", children: /* @__PURE__ */ jsxRuntime.jsx(
              designSystem.SingleSelect,
              {
                label: "Select Card Style",
                placeholder: "Select card",
                value: c2.cardStyle,
                onChange: (value) => onUpdateCardStyle(c2.uid, value),
                children: cardOptions.map((c22) => /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: c22.id, children: c22.label }, c22.id))
              }
            ) })
          ] })
        ] }) })
...
`;
const DangerActionButton = styled__default.default(ActionButton)`
  &:hover:not(:disabled) { background: ${({ theme }) => theme.colors.danger100}; color: ${({ theme }) => theme.colors.danger600}; }
`;
const SuggestedQuestions = ({ questions, onAddClick, onEditClick, onRemove }) => {
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { background: "neutral0", shadow: "filterShadow", hasRadius: true, paddingBottom: questions.length > 0 ? 4 : 0, marginBottom: 6, children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { padding: 6, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", alignItems: "center", children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", fontWeight: "bold", children: "Suggested Questions" }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "secondary", startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Plus, {}), onClick: onAddClick, children: "Add Suggestion" })
    ] }) }),
    questions.length > 0 && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { direction: "column", alignItems: "stretch", gap: 2, paddingLeft: 6, paddingRight: 6, paddingBottom: 4, children: questions.map((q2, index) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { padding: 3, hasRadius: true, background: "neutral100", justifyContent: "space-between", alignItems: "center", children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "omega", textColor: "neutral800", children: q2 }),
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 1, children: [
        /* @__PURE__ */ jsxRuntime.jsx(ActionButton, { onClick: () => onEditClick(index), title: "Edit", children: /* @__PURE__ */ jsxRuntime.jsx(icons.Pencil, {}) }),
        /* @__PURE__ */ jsxRuntime.jsx(DangerActionButton, { onClick: () => onRemove(index), title: "Remove", children: /* @__PURE__ */ jsxRuntime.jsx(icons.Trash, {}) })
      ] })
    ] }, index)) })
  ] });
};
const InstructionRow = ({
  ...
  /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingLeft: 6, paddingRight: 6, paddingTop: 4, paddingBottom: 4, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { justifyContent: "space-between", alignItems: "center", children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "omega", fontWeight: "bold", children: title }),
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { gap: 3, alignItems: "center", children: [
      !value && !isOpen && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "sigma", textColor: "danger600", fontWeight: "bold", children: "NOT CONFIGURED" }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "tertiary", onClick: onToggle, children: isOpen ? "Apply" : "Manage" })
    ] })
  ] }) }),
  isOpen && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingLeft: 6, paddingRight: 6, paddingBottom: 6, background: "neutral0", children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 2, children: /* @__PURE__ */ jsxRuntime.jsx(
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { background: "neutral0", shadow: "filterShadow", hasRadius: true, marginBottom: 6, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Box,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "delta", fontWeight: "bold", children: "Instructions" })
      }
    ),
    /* @__PURE__ */ jsxRuntime.jsx(
      InstructionRow,
...
const PopUp = ({ isOpen, onClose, onSave, type: type2, initialData, availableCollections = [] }) => {
  ...
  React.useEffect(() => {
    if (isPickerOpen) {
      const fetchAssets = async () => {
        ...
        try {
          const { data } = await get2("/upload/files?sort=createdAt:DESC&pagination[pageSize]=24");
  ...
  if (!isOpen || !type2) return null;
  const handleToggleCollection = (uid) => {
    setTempData(
      (prev) => prev.includes(uid) ? prev.filter((id) => id !== uid) : [...prev, uid]
    );
  };
  const getModalContent = () => {
    if (type2 === "logo" && isPickerOpen) {
      return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 4, alignItems: "stretch", children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "tertiary", startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.ArrowLeft, {}), onClick: () => setIsPickerOpen(false), children: "Back to Preview" }),
        isLoadingAssets ? /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { justifyContent: "center", padding: 8, children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Loader, {}) }) : /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { wrap: "wrap", gap: 4, children: assets.map((asset) => /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Box,
          {
            as: "button",
            type: "button",
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx("img", { src: asset.url, alt: asset.name, style: { width: "100%", height: "100%", objectFit: "cover" } })
          },
          asset.id
        )) })
      ] });
    ...
    switch (type2) {
      ...
      case "contact":
        return /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.TextInput,
          {
            label: type2 === "key" ? "API Key" : type2 === "domain" ? "Base Domain" : "Contact Link",
            placeholder: "...",
            type: type2 === "key" ? "password" : "text",
            value: tempData,
            onChange: (e2) => setTempData(e2.target.value)
          }
        );
      case "suggestion":
        return /* @__PURE__ */ jsxRuntime.jsx(
      ...
      case "style":
        return /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.Textarea,
          {
            label: type2 === "business" ? "Business Logic Prompt" : "Response Style Prompt",
            value: tempData,
            onChange: (e2) => setTempData(e2.target.value),
      ...
      case "logo":
        return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 4, alignItems: "stretch", children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", fontWeight: "bold", textColor: "neutral600", children: "Logo Preview" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.Box,
            {
              ...
              children: tempData ? /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 4, alignItems: "center", children: [
                /* @__PURE__ */ jsxRuntime.jsx("img", { src: tempData, alt: "Logo", style: { maxHeight: "120px", maxWidth: "100%", borderRadius: "4px" } }),
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "danger-light", startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Trash, {}), onClick: () => setTempData(""), children: "Remove Logo" })
              ] }) : /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", gap: 4, alignItems: "center", children: [
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { variant: "secondary", startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Plus, {}), onClick: () => setIsPickerOpen(true), children: "Select Logo" }),
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral500", children: "Pick from Media Library" })
              ] })
            }
          )
        ] });
      case "collections":
        return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, { direction: "column", gap: 3, children: availableCollections.map((col) => {
          ...
          return /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.Box,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, { direction: "column", alignItems: "flex-start", children: [
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { fontWeight: "bold", textColor: isSelected ? "primary600" : "neutral800", children: col.name }),
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral500", children: col.uid })
              ] })
            },
            col.uid
          );
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Root, { open: isOpen, onOpenChange: onClose, children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Content, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Header, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { fontWeight: "bold", as: "h2", children: titles[type2] }) }),
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Body, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { paddingTop: 2, paddingBottom: 2, children: getModalContent() }) }),
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Footer, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: onClose, variant: "tertiary", children: "Cancel" }),
      !isPickerOpen && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, { onClick: () => {
        onSave(tempData);
        onClose();
...
const HomePage = () => {
  ...
  const init = async () => {
    try {
      const { data } = await get2("/faqchatbot/collections");
      ...
      if (normalizedBase) {
        fetch(`${normalizedBase}/card-mapping.json`).then((res) => res.json()).then(setCardOptions).catch(() => setCardOptions([]));
      }
  ...
  const handlePopupSave = (data) => {
    if (activeModal === "collections") {
      const selectedUids = data;
      setActiveCollections((currentActive) => {
        const remaining = currentActive.filter((c2) => selectedUids.includes(c2.uid));
        const currentUids = currentActive.map((c2) => c2.uid);
        selectedUids.filter((uid) => !currentUids.includes(uid));
        const newlyAdded = allContentTypes.filter((ct) => selectedUids.includes(ct.uid) && !currentUids.includes(ct.uid)).map((ct) => JSON.parse(JSON.stringify(ct)));
  ...
  const save = async () => {
    ...
    try {
      ...
      await post("/faqchatbot/collections", {
        config: configToSave,
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { paddingLeft: 8, paddingTop: 2, paddingRight: 8, background: "neutral100", children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        ConfigSettings,
        {
          ...
          logoUrl,
          contactLink,
          onManage: (type2) => setActiveModal(type2)
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsx(
        CollectionSection,
        {
          ...
          isAddDisabled: allContentTypes.filter((c2) => c2.uid !== "plugin::faqchatbot.faqqa").length === activeCollections.length
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsx(
        SuggestedQuestions,
        {
          ...
          onRemove: (index) => {
            setSuggestedQuestions((prev) => prev.filter((_2, i2) => i2 !== index));
          }
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsx(
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      PopUp,
      {
        ...
        availableCollections: allContentTypes.filter(
          (c2) => c2.uid !== "plugin::faqchatbot.faqqa" && !activeCollections.some((active) => active.uid === c2.uid)
        ),
        initialData: activeModal === "collections" ? activeCollections.map((c2) => c2.uid) : activeModal === "suggestion" ? editingQuestionIndex !== null ? suggestedQuestions[editingQuestionIndex] : "" : activeModal === "key" ? openaiKey : activeModal === "domain" ? baseDomain : activeModal === "logo" ? logoUrl : contactLink
      }
    ),
